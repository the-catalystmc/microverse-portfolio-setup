...
{
  projectImg: './screenshots/spacetravelers.jpeg',
  projectTitle: 'Space Travelers Hub',
  projectDesc: 'A web application for a company that provides commercial and scientific space travel services.',
  modalDesc: 'A web application for a company that provides commercial and scientific space travel services. The application will allow users to book rockets and join selected space missions. All user interaction such as rocket booking and joining missions is managed by the SpaceX API. I was in charge of the design and logic for the rocket booking page.',
  technologies: ['react', 'sass', 'javaScript'],
  link1: 'https://the-catalystmc.github.io/space-travelers-hub/#/rockets',
  link2: 'https://github.com/the-catalystmc/space-travelers-hub',
  customStyle: 'row-reverse',
  projectQual: ['helo', 'hi', 'bye'],
},
{
  projectImg: './screenshots/convention.jpeg',
  projectTitle: 'Church Convention',
  projectDesc: 'This website is built to highlight an annual conference of churches.',
  modalDesc: ' This website is built to highlight an annual conference of churches. There is a home page which shows the different events at the conference. The speakers are loaded dynamically using javascript. There is also an about page that shares more information on the conference while the speakers page brings a user directly to the speakers section.',
  technologies: ['html', 'sass', 'javaScript'],
  link1: 'https://the-catalystmc.github.io/church-conference-capstone/index.html#home',
  link2: 'https://github.com/the-catalystmc/church-conference-capstone',
  customStyle: 'row',
  projectQual: ['helo', 'hi', 'bye'],
},
{
